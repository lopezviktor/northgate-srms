	...
	users := []seedUser{
		...
		},
		{
			...
			Record: seedEmployeeRecord{
				FirstName:          "Christine",
				LastName:           "Dawson",
				Email:              "christine.dawson@northgate.test",
				Phone:              "+44 7700 900011",
				Address:            "5 Bootham Crescent, York",
				EmergencyContact:   "Laura Dawson, +44 7700 900012",
				Department:         "HR",
				JobTitle:           "HR Manager",
				EmploymentStatus:   "active",
				SalaryBand:         "E",
				AccessibilityNotes: "",
				PrivateHRNotes:     "Second administrator account for assessment testing.",
			},
		},
		{
			Username: "alice",
